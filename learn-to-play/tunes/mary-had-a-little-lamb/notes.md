...
**Range check:** C5–G5. Only 5 distinct pitches — ideal for first-time learners.

**Practice tips:**
1. Four bars, then four bars again (varied). Total: 8 bars.
2. The half-note rests (e'2, d'2) — let the bar ring, don't mute it.
3. At ♩= 96, play evenly. This tune should sound mechanical and steady.
