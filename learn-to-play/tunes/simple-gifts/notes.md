...
**Practice tips:**
1. The tied final note (f8-) should sustain fully — let the resonator bloom.
2. The ascending 4th (F to Bb) in bar 3 is characteristic — don't skip over it.
3. Play with a singing, legato mallet style — oppose the usual staccato xylophone approach.
