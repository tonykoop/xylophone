...
## Music
```
X:5 T:Shady Grove M:3/4 L:1/4 Q:1/4=80 K:Dmin
a' | a' g' e' | d'2 e' | g'2 e' | d'3 |
d' e' g' | a'2 g' | e'2 d' | A3 |
(repeat for verse 2)
```

## Modal note
D dorian = D natural minor with B-natural (not Bb). This gives the tune its archaic, folk character.
